...
class JobForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'job_company': forms.Select(attrs={'class': 'form-control'}),
            ...
            'job_vacancy': forms.NumberInput(attrs={'class': 'form-control'}),
            'job_experience': forms.TextInput(attrs={'class': 'form-control'}),
            'job_salary': forms.TextInput(attrs={'class': 'form-control'}),
            'job_offer_end': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
...
class ApplicationForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'job_id': forms.Select(attrs={'class': 'form-control'}),
